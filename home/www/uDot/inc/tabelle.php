<?php 
    $output = "";
    $output .= '<a href="Unterwebseiten/StundenplanBearbeiten/StundenplanBearbeiten.php" style="position: absolute; top: -5em; right: 1em;" type="button" id="bearbeitenbutton" class="btn btn-primary">Bearbeiten</a>';
